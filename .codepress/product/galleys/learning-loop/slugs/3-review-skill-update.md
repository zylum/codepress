...
- [ ] `skills/review.md` step 1 instructs: read Slug Signals blocks, then synthesise into review.md
- [ ] Step 2 says "draft pattern candidates — human approves" not "identify patterns"
- [ ] The skill references the new review.md four-section structure
- [ ] Rework detection added: scan git log for `rework:` prefix in commit messages since galley started
