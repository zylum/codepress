...
- `05-domain/index.md` — domain context
- Relevant `04-patterns/patterns/`

Never start implementation without reading the Galley and Domain Memory.
...
Before marking the Galley done, run `skills/capture-pattern.md`:

1. Complete `review.md`:
   - List all Signals captured
   - Identify which warrant a Pattern
   - List Domain Memory updates needed
2. Promote Signals to `04-patterns/signals/`
3. Create or update Pattern files in `04-patterns/patterns/`
4. Update `05-domain/` as needed
5. Update Galley frontmatter: `status: done`
6. Update `03-delivery/board.md` — move card to Done
7. Commit: `galley:<name> done`

---

## Output
All Slugs complete with evidence. `review.md` filled. Domain Memory updated. Board updated.
